...
class Invoice(models.Model):
    ...
    shipped_to_json    = models.JSONField("Адреса отримувача (повна)", default=dict, blank=True)
...
class ShippingSettings(models.Model):
    ...
    trust_cached_tracking = models.BooleanField(
        "Довіряти кешу при збої API", default=False,
        help_text=(
    ...
    order_status_lock_delivered = models.BooleanField(
        "Блокувати статус після «Доставлено»", default=True,
        help_text=(
